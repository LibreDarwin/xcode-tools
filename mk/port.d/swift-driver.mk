...
# with CMake against the ports before it: the argument parser and llbuild's
# Swift bindings statically, as Apple's are, and libSwiftToolsSupport.dylib
# dynamically, through the TSCConfig that port writes.
#
...
P_CONFIGURE_ARGS=	${SWIFT_CMAKE_ARGS} \
	...
	-DLLBuild_DIR=${TOP}/build/ports/llbuild/build/cmake/modules
